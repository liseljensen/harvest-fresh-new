...
app.directive("masonry", function ($window) {
    ...
    return {
        compile: function(element, attrs) {
            ...
            return function (scope, element, attrs) {
                ...
                setTimeout(function () {
                    $window.jQuery(element).masonry(options);
                    
                    $window.jQuery(element).on("$destroy", function () {
                        $window.jQuery(element).masonry('destroy')
                    });
                    ...
                    if (options.model) {
                        scope.$apply(function() {
                            scope.$watchCollection(options.model, function (_new, _old) {
                                ...
                                // Wait inside directives to render
                                setTimeout(function () {
                                    $window.jQuery(element).masonry("reload");
                                });
                            });
                        });
                    }
